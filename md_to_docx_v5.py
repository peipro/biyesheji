...
def markdown_to_docx(md_file_path, docx_file_path):
    ...
    for line in lines:
            ...
            if in_table and table_data:
                ...
                if len(table_data) > 0:
                    ...
                    if cols > 0:
                        ...
                        table.style = 'Table Grid'  # 使用完整网格样式，黑色边框
        ...
        if stripped and stripped[0].isdigit() and '.' in stripped[:3]:
            in_table = False
            processed_text, is_ordered = process_ordered_list(stripped)
            text_clean = clean_text(processed_text)
